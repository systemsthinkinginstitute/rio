...
/* unused harmony export rio */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_morphdom__ = __webpack_require__(2);
...
class View {
  ...
  update() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_morphdom___default()(this.el, newHTML);
...
const app = new __WEBPACK_IMPORTED_MODULE_1__list_js__["a" /* default */](items);
...
class ListView extends __WEBPACK_IMPORTED_MODULE_0____["a" /* View */] {
  ...
  render() {
    return this.tmpl`
      <div class="listing">
        LISTING:
        ${this.items.map(item => new __WEBPACK_IMPORTED_MODULE_1__item__["a" /* default */](item))}
      </div>
    `;
  }
...
class ItemView extends __WEBPACK_IMPORTED_MODULE_0____["a" /* View */] {
